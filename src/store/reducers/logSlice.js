...
export const logSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(GET_ACCESS_LOG.rejected, (state, action) => {
      state.status = "failed";
    ...
    builder.addCase(GET_HEALTHCHECK_LOG.rejected, (state, action) => {
      state.status = "failed";
      state.error = action.payload.msg;
    });
    ...
    builder.addCase(GET_RSSI_LOG.rejected, (state, action) => {
      state.status = "failed";
      state.error = action.payload.msg;
    });
  },
